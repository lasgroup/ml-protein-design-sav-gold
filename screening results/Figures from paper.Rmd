...
#Load results
SSM_screening <- read_excel("Data/Combined data sets.xlsx", sheet = "SSM screening")
...
#Load results
mutational_load <- read_excel("Data/Combined data sets.xlsx", sheet = "Mutational load")
...
#Load data
initial_screening <- read_excel("Data/Combined data sets.xlsx", sheet = "Initial screening")
...
read_excel("Data/Combined data sets.xlsx", sheet = "Initial screening") %>%
  filter(type == "mutant",
         OD >= 0.05) %>%
  distinct(variant) %>%
...
#Load data
all_rounds <- read_excel("Data/Combined data sets.xlsx", sheet = "All rounds")
...
read_excel("Data/Combined data sets.xlsx", sheet = "Hit validation") %>%
...
clustering <- fread("Data/coordinates_embedding150.csv")
